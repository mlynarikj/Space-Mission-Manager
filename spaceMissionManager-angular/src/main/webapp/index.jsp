    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li ng-if="user.manager"><a href="#!/users">Users</a></li>
                <li ng-if="user.manager"><a href="#!/missions">Missions</a></li>
                <li ng-if="user.manager"><a href="#!/spacecrafts">Spacecrafts</a></li>
                <li ng-if="user.manager"><a href="#!/components">Craft components</a></li>
            </ul>
